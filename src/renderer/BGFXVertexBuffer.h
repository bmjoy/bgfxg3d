...
public:
    ...
    static void createVertexDecl(const VertexFormat &vertexFormat, bgfx::VertexLayout&vertexDecl);
    const bgfx::VertexLayout getVertexDecl() const { return _vertexDecl; }
...
private:
    ...
    bgfx::VertexLayout _vertexDecl;               // vertex declaration
};
